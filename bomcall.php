...
\033[95m=============================================\n
\033[95mauthor : \033[91mMr.Gaming (Hacker-Cibodas)
\033[95mgithub : \033[91mhttps://github.com/clayhacker-max\n
\033[95m=============================================\n";
...
if($pill == 'y') {
	...
	echo $banner;
	echo "\n";
	echo "\033[92m*_* Masukkan Nomor\n\033[00mInput : ";
	$nomor = trim(fgets(STDIN));
	sleep(1);
	echo "\033[91m\n*_* HANYA UNTUK 3 KALI SPAM DALAM 1 NOMOR";
	sleep(2);
	echo "\n\n\033[92mRESULTS\n\n";
	sleep(1);
	$execute = send($nomor);
	print $execute;
		...
		echo "\n\n\033[91m*_* TERIMA KASIH \033[93mTELAH GUNAKAN \033[92mTOOLS INI\n";
		exit;
		}
?>
